# ==============================================================================
# Figure 3B: Volcano - WT Tm (12h) vs WT Tm (6h)
# ==============================================================================
# Script: fig3b_volcano_12h_vs_6h.R
# Output: fig3b_volcano_12h_vs_6h.png/pdf, fig3b_volcano_12h_vs_6h_data.csv
# Description: Timecourse volcano for mid-phase UPR response (12h vs 6h).
# ==============================================================================
...
message("Running: fig3b_volcano_12h_vs_6h")
...
res <- results(dds, contrast = c("group", "WT_Tm_12", "WT_Tm_6"), cooksCutoff = DESEQ_COOKS_CUTOFF)
if (exists("USE_LFC_SHRINK") && USE_LFC_SHRINK) {
    message("  Applying LFC shrinkage (ashr)...")
    res <- lfcShrink(dds, contrast = c("group", "WT_Tm_12", "WT_Tm_6"), res = res, type = "ashr")
}
...
write.csv(res_df, file.path(DESEQ_DIR, "fig3b_volcano_12h_vs_6h_data.csv"), row.names = FALSE)
...
plot_title <- if (!is.null(PLOT_TITLES$fig3b_volcano_12h_vs_6h$main)) {
    PLOT_TITLES$fig3b_volcano_12h_vs_6h$main
} else {
    "WT Tm (12h) vs WT Tm (6h)"
}
...
# --- STEP 6: Save Figure ---
save_figure(p, "fig3b_volcano_12h_vs_6h", width = VOLCANO$WIDTH, height = VOLCANO$HEIGHT, dir = FIG3_DIR)

message("Done: fig3b_volcano_12h_vs_6h")
