# ==============================================================================
# Figure 3C: Volcano - WT Tm (24h) vs WT Tm (12h)
# ==============================================================================
# Script: fig3c_volcano_24h_vs_12h.R
# Output: fig3c_volcano_24h_vs_12h.png/pdf, fig3c_volcano_24h_vs_12h_data.csv
# Description: Timecourse volcano for late-phase UPR response (24h vs 12h).
# ==============================================================================
...
message("Running: fig3c_volcano_24h_vs_12h")
...
res <- results(dds, contrast = c("group", "WT_Tm_24", "WT_Tm_12"), cooksCutoff = DESEQ_COOKS_CUTOFF)
if (exists("USE_LFC_SHRINK") && USE_LFC_SHRINK) {
    message("  Applying LFC shrinkage (ashr)...")
    res <- lfcShrink(dds, contrast = c("group", "WT_Tm_24", "WT_Tm_12"), res = res, type = "ashr")
}
...
write.csv(res_df, file.path(DESEQ_DIR, "fig3c_volcano_24h_vs_12h_data.csv"), row.names = FALSE)
...
plot_title <- if (!is.null(PLOT_TITLES$fig3c_volcano_24h_vs_12h$main)) {
    PLOT_TITLES$fig3c_volcano_24h_vs_12h$main
} else {
    "WT Tm (24h) vs WT Tm (12h)"
}
...
# --- STEP 6: Save Figure ---
save_figure(p, "fig3c_volcano_24h_vs_12h", width = VOLCANO$WIDTH, height = VOLCANO$HEIGHT, dir = FIG3_DIR)

message("Done: fig3c_volcano_24h_vs_12h")
