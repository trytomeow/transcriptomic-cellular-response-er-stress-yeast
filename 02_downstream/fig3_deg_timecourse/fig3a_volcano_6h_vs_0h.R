# ==============================================================================
# Figure 3A: Volcano - WT Tm (6h) vs WT Tm (0h)
# ==============================================================================
# Script: fig3a_volcano_6h_vs_0h.R
# Output: fig3a_volcano_6h_vs_0h.png/pdf, fig3a_volcano_6h_vs_0h_data.csv
# Description: Timecourse volcano for early UPR response (6h vs 0h baseline).
# ==============================================================================
...
message("Running: fig3a_volcano_6h_vs_0h")
...
write.csv(res_df, file.path(DESEQ_DIR, "fig3a_volcano_6h_vs_0h_data.csv"), row.names = FALSE)
...
plot_title <- if (!is.null(PLOT_TITLES$fig3a_volcano_6h_vs_0h$main)) {
    PLOT_TITLES$fig3a_volcano_6h_vs_0h$main
} else {
    "WT Tm (6h) vs WT Tm (0h)"
}
...
# --- STEP 6: Save Figure ---
save_figure(p, "fig3a_volcano_6h_vs_0h", width = VOLCANO$WIDTH, height = VOLCANO$HEIGHT, dir = FIG3_DIR)

message("Done: fig3a_volcano_6h_vs_0h")
