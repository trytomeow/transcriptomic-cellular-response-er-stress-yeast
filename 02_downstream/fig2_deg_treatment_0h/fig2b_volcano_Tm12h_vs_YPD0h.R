# ==============================================================================
# Figure 2B: Volcano - WT Tm (12h) vs YPD (0h)
# ==============================================================================
# Script: fig2b_volcano_Tm12h_vs_YPD0h.R
# Output: fig2b_volcano_Tm12h_vs_YPD0h.png/pdf,
#         fig2b_volcano_Tm12h_vs_YPD0h_data.csv
# Description: DEG volcano plot comparing Tm treatment at 12h to baseline.
# ==============================================================================
...
message("Running: fig2b_volcano_Tm12h_vs_YPD0h")
...
res <- results(dds, contrast = c("group", "WT_Tm_12", "WT_YPD_0"), cooksCutoff = DESEQ_COOKS_CUTOFF)
if (exists("USE_LFC_SHRINK") && USE_LFC_SHRINK) {
    message("  Applying LFC shrinkage (ashr)...")
    res <- lfcShrink(dds, contrast = c("group", "WT_Tm_12", "WT_YPD_0"), res = res, type = "ashr")
}
...
write.csv(res_df, file.path(DESEQ_DIR, "fig2b_volcano_Tm12h_vs_YPD0h_data.csv"), row.names = FALSE)
...
plot_title <- if (!is.null(PLOT_TITLES$fig2_volcano_Tm12h_vs_YPD0h$main)) {
    PLOT_TITLES$fig2_volcano_Tm12h_vs_YPD0h$main
} else {
    "Volcano Plot: WT Tm (12h) vs WT YPD (0h)"
}
...
# --- STEP 6: Save Figure ---
save_figure(p, "fig2b_volcano_Tm12h_vs_YPD0h", width = VOLCANO$WIDTH, height = VOLCANO$HEIGHT, dir = FIG2_DIR)

message("Done: fig2b_volcano_Tm12h_vs_YPD0h")
