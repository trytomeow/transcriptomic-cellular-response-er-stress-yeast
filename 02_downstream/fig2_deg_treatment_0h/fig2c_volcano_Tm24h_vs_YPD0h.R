# ==============================================================================
# Figure 2C: Volcano - WT Tm (24h) vs YPD (0h)
# ==============================================================================
# Script: fig2c_volcano_Tm24h_vs_YPD0h.R
# Output: fig2c_volcano_Tm24h_vs_YPD0h.png/pdf,
#         fig2c_volcano_Tm24h_vs_YPD0h_data.csv
# Description: DEG volcano plot comparing Tm treatment at 24h to baseline.
# ==============================================================================
...
message("Running: fig2c_volcano_Tm24h_vs_YPD0h")
...
res <- results(dds, contrast = c("group", "WT_Tm_24", "WT_YPD_0"), cooksCutoff = DESEQ_COOKS_CUTOFF)
if (exists("USE_LFC_SHRINK") && USE_LFC_SHRINK) {
    message("  Applying LFC shrinkage (ashr)...")
    res <- lfcShrink(dds, contrast = c("group", "WT_Tm_24", "WT_YPD_0"), res = res, type = "ashr")
}
...
write.csv(res_df, file.path(DESEQ_DIR, "fig2c_volcano_Tm24h_vs_YPD0h_data.csv"), row.names = FALSE)
...
plot_title <- if (!is.null(PLOT_TITLES$fig2_volcano_Tm24h_vs_YPD0h$main)) {
    PLOT_TITLES$fig2_volcano_Tm24h_vs_YPD0h$main
} else {
    "Volcano Plot: WT Tm (24h) vs WT YPD (0h)"
}
...
# --- STEP 6: Save Figure ---
save_figure(p, "fig2c_volcano_Tm24h_vs_YPD0h", width = VOLCANO$WIDTH, height = VOLCANO$HEIGHT, dir = FIG2_DIR)

message("Done: fig2c_volcano_Tm24h_vs_YPD0h")
